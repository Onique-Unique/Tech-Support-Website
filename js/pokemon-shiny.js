...
pokemon_selector.onchange = function () {
    ...
    if (current != "412") {
        pokemon.src = "https://github.com/Onique-Unique/PogoAssets/blob/master/pokemon_icons/pokemon_icon_" + current + "_00.png?raw=true";
        shiny.src = "https://github.com/Onique-Unique/PogoAssets/blob/master/pokemon_icons/pokemon_icon_" + current + "_00_shiny.png?raw=true";
    } else { // Burmy
        pokemon.src = "https://github.com/Onique-Unique/PogoAssets/blob/master/pokemon_icons/pokemon_icon_" + current + "_11.png?raw=true";
        shiny.src = "https://github.com/Onique-Unique/PogoAssets/blob/master/pokemon_icons/pokemon_icon_" + current + "_11_shiny.png?raw=true";
    }
...
function addSparkles() {
    for (var i = 0; i < 8; i++) particles.push({
        "scale": 1,
        "radius": 60,
        "angle": 45 * i
    });
...
popupInnerContent.appendChild(paraP);
