document.getElementById("video-lounge").innerHTML = `
<div class="lounge-flex">
    <div class="video-carousel">
        ...
        <div id="video-embed">
            <iframe id="embed-video" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; fullscreen" src="https://www.youtube.com/embed/sTIlYH7IFfQ" frameborder="0"></iframe>
        </div>
