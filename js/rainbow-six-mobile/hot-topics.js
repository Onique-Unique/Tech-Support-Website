...
for(let i = 0; i < topics.length; i++){
    ...
    <p> Reddit sources have included Rainbow Six Mobile as one of the hottest upcoming games to be featured on mobile devices.
        Rainbow Six Mobile is deemed as one of Respawns most exciting upcoming releases, the enthusiasm is high.
    </p>`
};
